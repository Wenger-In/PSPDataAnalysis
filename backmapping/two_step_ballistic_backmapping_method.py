...
def two_step_backmapping(datetime_trace, r_beg_au, lat_beg_deg, lon_beg_deg, Vsw_r, r_source_surfae_rs, dir_data_PFSS):
...
datetime_trace = datetime.datetime(2021, 1, 17, 13, 0, 0)
r_beg_au = 0.0951375  # au
lon_beg_deg = 83.3126373  # deg frame: Carrington
lat_beg_deg = -3.4472659  # deg frame: Carrington
Vsw_r = 275.7 # km/s
r_source_surfae_rs = 2.5 # Rs
dir_data_PFSS = 'E:/Research/Data/GONG/' # 存放Gong的磁图

# 两步回溯
r_footpoint_on_SourceSurface_rs, lon_footpoint_on_SourceSurface_deg, lat_footpoint_on_SourceSurface_deg, \
MFL_photosphere_lon_deg, MFL_photosphere_lat_deg\
    =two_step_backmapping(datetime_trace, r_beg_au, lat_beg_deg, lon_beg_deg, Vsw_r, r_source_surfae_rs, dir_data_PFSS)
# 输出结果
print('----------------------------------')
